package com.hw.config.security.filter;

import com.hw.config.redis.RedisService;
import com.hw.config.security.CustomerUserDetailsService;
import com.hw.config.security.LoginFailureHandler;
import com.hw.config.security.exception.CustomerAuthenticationException;
...
public class CheckTokenFilter extends OncePerRequestFilter {
    ...
    @Value("${request.url.oauth}")
    private String oauthUrl;
    @Value("${request.url.api}")
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (!url.equals(loginUrl) && !url.matches(oauthUrl) && !url.matches(apiUrl)) {
